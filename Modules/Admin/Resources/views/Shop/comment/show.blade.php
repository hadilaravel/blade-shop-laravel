    ...
    <div class="row">
        <div class="col-md-12">
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('admin.shop.comment.index') }}" class="btn btn-info btn-sm">بازگشت</a>
            </section>
            <div class="card">
                <div class="card-header">
                    <div class="card-title-wrap bar-success">
                        <h4 class="card-title" id="horz-layout-basic"> نام نویسنده :  {{ $comment->user->name }}</h4>
                    </div>
                    <h4>توضیحات : </h4>
                ...
                <div class="card-body">
                    <div class="px-3">
                        <form class="form form-horizontal" method="post" action="{{ route('admin.shop.comment.answer' , $comment->id) }}">
                            @csrf
                            <div class="form-body">
