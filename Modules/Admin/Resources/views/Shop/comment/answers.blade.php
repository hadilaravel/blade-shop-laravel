                                        ...
                                        <td class="width-8-rem text-left">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <a href="{{ route('admin.shop.comment.show', $answer->id) }}" class="dropdown-item text-right text-white bg-secondary"><i class="fa fa-eye "></i>  نمایش  </a>
                                                    <form class="d-inline" action="{{ route('admin.shop.comment.destroy', $answer->id) }}" method="post">
                                                        @csrf
                                                        {{ method_field('delete') }}
