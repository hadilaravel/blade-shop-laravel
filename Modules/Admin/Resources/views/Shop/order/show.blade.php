...
{{--                                    </a>--}}
                            ...
                            <tr class="border-bottom">
                                <th>تاریخ ارسال</th>
                                <td class="text-left font-weight-bolder">
                                    {{ convertEnglishToPersian(jdate($order->delivery_time)->format('Y-m-d')) }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-left font-weight-bolder">
                                    {{ priceFormat($order->order_discount_amount) ?? '-' }} تومان
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>مبلغ تخفیف همه محصولات</th>
                                <td class="text-left font-weight-bolder">
                                    {{ priceFormat($order->order_total_products_discount_amount) ?? '-' }} تومان
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>مبلغ نهایی</th>
                                <td class="text-left font-weight-bolder">
                                    {{ priceFormat($order->order_final_amount -  $order->order_discount_amount) }} تومان
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>بانک</th>
