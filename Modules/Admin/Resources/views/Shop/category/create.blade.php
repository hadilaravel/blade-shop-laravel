...
@section('head-tag')
<title>ایجاد دسته بندی محصول</title>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="px-3">
                            <form class="form form-horizontal"  action="{{ route('admin.shop.category.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">

                                    <h4 class="form-section">
                                        ایجاد دسته بندی محصول</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select id="projectinput6" name="status_header" class="form-control">
                                                <option value="0" @if(old('status_header') == 0) selected @endif>غیرفعال</option>
                                                <option value="1" @if(old('status_header') == 1) selected @endif>فعال</option>
                                            </select>
                                            @error('status_header')
                                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                           <strong>
