...
@section('content')
        ...
        <div class="md:w-[100%] mx-auto md:mt-5 hidden md:block">
            <div dir="ltr" class="owl-carousel">
                <div class="box-border">
                    <a href="#"
                    ><img class="rounded-md md:rounded-3xl md:px-2 box-border" src="./assets/image/heroSlider/1.jpg" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="#"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="./assets/image/heroSlider/2.jpg" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="#"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="./assets/image/heroSlider/3.gif" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="#"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="./assets/image/heroSlider/4.jpg" alt=""
                        /></a>
                </div>
            </div>
        </div>
        ...
        <div class="md:w-[100%] mx-auto md:mt-5 md:hidden">
            <div dir="ltr" class="owl-carousel">
                <div class="box-border">
                    <a href="./search.html"
                    ><img class="rounded-md md:rounded-3xl md:px-2 box-border" src="./assets/image/heroSlider/1-mobile.jpg" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="./search.html"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="./assets/image/heroSlider/2-mobile.jpg" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="./search.html"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="./assets/image/heroSlider/3-mobile.gif" alt=""
                        /></a>
                </div>
                <div class="box-border">
                    <a href="./search.html"
                    ><img class="rounded-md md:rounded-3xl md:px-2 " src="./assets/image/heroSlider/4-mobile.jpg" alt=""
                        /></a>
                </div>
            </div>
        </div>
        ...
        <div>
            <a href="./search.html">
                <img class="rounded-2xl hidden md:block" src="assets/image/sectionImage/1.jpg" alt="">
            </a>
            <a href="./search.html"></a>
            <img class="rounded-2xl md:hidden" src="assets/image/sectionImage/1-mobile.jpg" alt="">
            </a>
        </div>
        <!-- OFF SLIDER -->
        ...
        <div class="lg:flex items-start gap-5">
            <div class="lg:w-1/3 mb-5 gap-5 lg:mb-0 grid justify-items-center grid-cols-1 sm:grid-cols-2 lg:block">
                <img class="rounded-xl mx-auto" src="./assets/image/suggested product/9.webp" alt="">
                <img class="rounded-xl lg:hidden" src="./assets/image/suggested product/10.webp" alt="">
            </div>
            <div class="lg:w-2/3">
                <div class="swiper timerProduct border rounded-xl">
                    <div class="swiper-wrapper bg-white">
                        <a href="" class="swiper-slide md:flex bg-white" style="display: flex;">
                            <div class="md:w-1/3">
                                <img class="max-w-80 w-auto mx-auto rounded-xl" src="./assets/image/suggested product/1.webp" alt="">
                            </div>
                            <div class="md:w-2/3 flex flex-col justify-center py-5">
                                ...
                                <div class="clockdiv flex text-red-600 bg-red-100 px-3 py-1 rounded-md mt-6 text-center mx-auto" data-date="January 29, 2025 21:00:00">
                                    <div>
        ...
        <div class="swiper mySwiper bg-red-500 rounded-3xl mb-10">
            <div class="swiper-wrapper py-5">
                <div class="card swiper-slide flex flex-col justify-center items-center">
                    <img src="./assets/image/FeaturedPromos.svg" alt="">
                    <img class="w-full" src="./assets/image/box.webp" alt="">
                </div>
                <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 bg-white rounded-xl">
              ...
              <span class="text-sm opacity-80 mb-4 h-8 md:h-10">
                <div>
                  هنذفری بلوتوثی شیائومی
                    ...
                    <div dir="ltr" class="clockdiv flex text-red-600 text-sm mt-2" data-date="December 22, 2025 21:14:01">
                        <div>
                            <span class="hours"></span>
                            <span class="mr-1">:</span>
                        </div>
        ...
        <div class="bg-white rounded-2xl pt-10 shadow-xl my-10">
            <!-- TOP SLIDER -->
            <div class="flex justify-between px-5 md:px-10 items-center">
                <div class="border-b-2 border-red-500 pb-1">مخصوص سرما</div>
                <a href="./search.html"><div class="transition px-4 py-2 rounded-xl flex justify-center items-center text-red-500 hover:text-red-600">دیدن همه<img class="w-4" src="./assets/image/arrow-left.png" alt=""></div></a>
            </div>
            <!-- SLIDER -->
            <div class="containerPSlider swiper">
                <div class="slide-container1 px-2">
                    <div class="card-wrapper swiper-wrapper py-4">
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="./assets/image/productSlider/13.jpg" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      کیسه خواب
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="./assets/image/productSlider/14.jpg" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      صاف کننده کمر و گردن
                    </div>
                  </span>
                                <div class="flex justify-center text-xs opacity-75">
                                    <div class="line-through">1.350.000</div>
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="./assets/image/productSlider/15.jpg" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      پالتو تمام چرم
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="./assets/image/productSlider/16.jpg" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                      مرطوب کننده هوا
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="./assets/image/productSlider/17.jpg" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                    <div>
                     ساعت زنانه
                        ...
                        <a href="./single-product.html" class="card swiper-slide my-2 p-2 md:p-3 ">
                            <div class="image-box mb-6 ">
                                <div>
                                    <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="./assets/image/productSlider/18.jpg" alt="" />
                                </div>
                            </div>
                            <div class="space-y-3 text-center">
                  <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
