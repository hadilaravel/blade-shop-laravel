                      ...
                      d="M12.76 3.76a6 6 0 0 1 8.48 8.48l-8.53 8.54a1 1 0 0 1-1.42 0l-8.53-8.54a6 6 0 0 1 8.48-8.48l.76.75.76-.75zm7.07 7.07a4 4 0 1 0-5.66-5.66l-1.46 1.47a1 1 0 0 1-1.42 0L9.83 5.17a4 4 0 1 0-5.66 5.66L12 18.66l7.83-7.83z"></path>
                        ...
                        <div>
                            <div class="max-w-[300px] mx-auto">
                                ...
                                @endphp
                                <img class="mySlides rounded-xl md:rounded-3xl" src="{{ asset($images->first()) }}" style="width:100%">

                            </div>
                            <div class="flex justify-around gap-x-4 mt-3">
                                @foreach ($images as $key => $image)
                                <div class="max-w-[80px]">
                                    <img class="rounded-xl opacity-70 hover:opacity-100 transition" src="{{ asset($image) }}" onclick="currentDiv({{ $image }})">
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="w-full lg:w-2/3 mt-5 md:mt-0">
                        ...
                        <div class="md:flex sm:pr-7">
                            <div class="md:w-2/3">
                                                    ...
                                                    <div class="inline-flex items-center" >
                                                        ...
                                                        >
                                                            <input
                                                                id="color_{{ $color->id }}"
                                                                name="color"
                                                                data-color-name="{{ $color->name }}" data-color-price={{ $color->price_increase }}
                                                                type="radio"
                                ...
                                <div>
                                    <p><span>رنگ انتخاب شده : <span id="selected_color_name"> {{ $colors->first()->name }}</span></span></p>
                                </div>
                                @endif
                ...
                <span class="border-b-red-500 border-b">
                  ...
                  طراحی کاربر پسند
                            ...
                            <div class="md:flex gap-3">
                                ...
                                <img class="max-w-[320px] w-full mx-auto rounded-3xl" src="./assets/image/product/good.jpg" alt="">
                            </div>
                        </div>
              ...
              <span class="border-b-red-500 border-b">
                ...
                <div class="bg-white rounded-2xl pt-10">
                    ...
                    <div class="flex justify-between px-5 md:px-10 items-center">
                        ...
                        <a href="#"><div class="transition px-4 py-2 rounded-xl flex justify-center items-center text-red-500 hover:text-red-600">دیدن همه<img class="w-4" src="./assets/image/arrow-left.png" alt=""></div></a>
                    </div>
                    <!-- SLIDER -->
                ...
                <span class="card swiper-slide my-2 p-2 md:p-3 ">
                  ...
                  <div class="image-box mb-6 ">
                    <a href="">
                      <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="./assets/image/productSlider/5.jpg" alt="" />
                    </a>
                  </div>
                  <div class="space-y-3 text-center">
                    <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                  ...
                  <div class="image-box mb-6 ">
                    <a href="">
                      <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="./assets/image/productSlider/6.jpg" alt="" />
                    </a>
                  </div>
                  <div class="space-y-3 text-center">
                    <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
